...
public class LoginActivity extends Activity {
	...
	public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {
			try {
				int user_id = DBLoader.getInstance().checkUsernameAndPassword(
						mUserName, mPassword);
				userData = DBLoader.getInstance().getUser_data(mUserName,
						user_id);
		...
		protected void onPostExecute(final Boolean success) {
			...
			if (success) {
				Intent i = new Intent(LoginActivity.this, MappingActivity.class);
				startActivity(i);
				finish();
			} else {
				mPasswordView

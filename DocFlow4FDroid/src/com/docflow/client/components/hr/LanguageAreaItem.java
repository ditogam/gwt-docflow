...
public class LanguageAreaItem extends TextAreaItem implements LanguageValueSet {
	private Long id;

	public LanguageAreaItem() {
		constructItem();
	}

	public LanguageAreaItem(JavaScriptObject jsObj) {
		super(jsObj);
		constructItem();
	}

	public LanguageAreaItem(String name) {
		super(name);
		constructItem();
	}

	public LanguageAreaItem(String name, String title) {
		super(name, title);
		constructItem();
	}
	...
	private void showCaptionInput(HashMap<Integer, Captions> result) {
		WCaptions.showForm(false, id, getTitle(), this, result);
	}
}

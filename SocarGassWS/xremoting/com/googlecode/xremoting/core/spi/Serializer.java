...
public interface Serializer {
	 ...
	 *            returned type
	 * @param is
	 *            input stream from which to deserialize
	 * @return deserialized object
	 * @throws SerializationException
	 *             if something specific to serializer happened during the
	 *             serialization
	 * @throws IOException
	 *             if input/output error happened
	 */
	<T> T deserialize(InputStream is) throws SerializationException,
			IOException;
	 ...
	 *            object to serialize
	 * @param os
	 *            output stream to which to serialize
	 * @throws SerializationException
	 *             if something specific to serializer happened during the
	 *             serialization
	 * @throws IOException

 ...
 * 
 * <pre>
 * XRemotingProxyFactory factory = new XRemotingProxyFactory(
 * 		&quot;http://yourhost.com/your-service&quot;);
 ...
 * which allows to invoke service exposed via HTTP (it is the default option for
 * the simplest constructor {@link #XRemotingProxyFactory(String)}).
 * </p>
 * <p>
...
public class XRemotingProxyFactory {
	 ...
	 *            class of a {@link Serializer} implementation
	 */
	public XRemotingProxyFactory(Requester requester,
	 ...
	 *            name of the {@link Serializer} implementation class
	 */
	 ...
	 * @param serializerClassName
	 *            name of the {@link Serializer} implementation class
	 * @param spiClassLoader
	 *            classloader from which to load Serializer implementation
	 */
	public XRemotingProxyFactory(Requester requester,
			String serializerClassName, ClassLoader spiClassLoader) {
	...
	/**
	 * Creates a proxy for the given interface. Default classloader will be used
	 * for proxy. Default classloader is determined like this:
	 * <ol>
	 * <li>if context classloader is defined, it's used</li>
	 * <li>else classloader which loaded this class is used</li>
	 * </ol>
	...
	/**
	 * Creates a proxy for the given interfaces. Default classloader will be
	 * used for proxy. Default classloader is determined like this:
	 * <ol>
	 * <li>if context classloader is defined, it's used</li>
	 * <li>else classloader which loaded this class is used</li>
	 * </ol>
	 * 
	 * @param ifaces
	 *            interfaces for which to create proxy
	 * @return proxy
	 */
	...
	public Object create(Class<?>[] ifaces, ClassLoader proxyLoader) {
		Object o= Proxy.newProxyInstance(proxyLoader, ifaces,
	...
	private void init(Requester requester,
			Class<? extends Serializer> serializerClass) {
	...
	private void init(Requester requester, String serializerClassName,
		...
		try {
			clazz = (Class<? extends Serializer>) Class.forName(
					serializerClassName, true, spiClassLoader);

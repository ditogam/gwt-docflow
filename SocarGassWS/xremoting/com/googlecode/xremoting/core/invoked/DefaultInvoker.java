...
public class DefaultInvoker implements Invoker {
	...
	protected void checkMethod(Method method, InvocationRestriction restriction)
		...
		if (!allowed) {
			throw new InvokedSideInvocationException("The given method ("
					+ method + ") is not defined by any of exposed interfaces");
		}
	}
	...
	public Object invoke(Object target, Invocation invocation,
		...
		try {
			Method method = target.getClass().getMethod(
					invocation.getMethodName(), invocation.getArgTypes());

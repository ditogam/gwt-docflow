...
public interface Invoker {
	 ...
	 * @param invocation
	 *            what to invoke, and parameters
	 * @param restriction
	 *            attributes which define how invocation will be restricted
	 * @return invocation result
	 * @throws InvokedSideInvocationException
	 *             thrown if something is wrong with invocation itself, like
	 *             NoSuchMethodException or alike. Also, thrown if invocation is
	 *             not allowed due to restriction.
	 * @throws Throwable

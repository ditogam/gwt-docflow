...
if(isc.Log && isc.Log.logDebug)isc.Log.logDebug(isc._pTM.message,'loadTime');
...
else isc._preLog=[isc._pTM]}isc.definingFramework=true;if(window.isc&&isc.version!="v10.0p_2014-09-18/EVAL Development Only"){
    isc._optionalModuleCompare=function(){
        ...
        if(isc.version.toLowerCase().contains("pro")||isc.version.toLowerCase().contains("lgpl")){
            ...
            var moduleVersion="v10.0p_2014-09-18/EVAL Development Only";
...
isc.evalBoundary;isc.B.push(isc.A.getRowFacetWidths=function isc_CubeGrid_getRowFacetWidths(){

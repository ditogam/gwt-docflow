...
var importDialog, importPane, canvas;
...
(function createBMMLImportDialog(dialogProperties) {
	...
	// Now observe importDialog hide() and close(), so it propagates to importPane
	importPane.observe(importPane.importDialog, "hide", "observer.hide();");
	importPane.observe(importPane.importDialog, "closeClick", "observer.close();");
	    ...
	    sampleFiles = isc.VLayout.create({
			...
			textDefaults: {
				...
				contents: "<div style='margin-left:10px'>" +
					"If you don't have any Balsamiq files, " +
					"try using these to test out Reify:" +
					"</div>" +
					"<ul style=\"margin-left: -1em;\">" +
					"<li><a href=\"https://isomorphic.mybalsamiq.com/projects/testproject/example+mockup+for+Balsamiq+resizebars+and+layouts.bmml\">Resize bars & Layouts</a></li>" +
					"<li><a href=\"https://isomorphic.mybalsamiq.com/projects/testproject/example+mockup+for+demo+3+v1.0.bmml\">Navigation, Charts</a></li>" +
					"</ul>"
			},

...
public class JDBCResultSet implements java.sql.ResultSet {
	...
	private static final boolean nullrepl = jsqlite.Database.version()
			.compareTo("2.5.0") < 0;
	...
	public boolean isUpdatable() throws SQLException {
		if (updatable == UPD_UNKNOWN) {
			try {
				...
				updatable = UPD_INS;
				uptable = lastt;
				JDBCResultSet pk = (JDBCResultSet) s.conn.getMetaData()
						.getPrimaryKeys(null, null, uptable);
				if (pk.tr.nrows > 0) {
	...
	public void fillRowbuf() throws SQLException {
		if (rowbuf == null) {
			...
			System.arraycopy((String[]) tr.rows.elementAt(row), 0, rowbuf, 0,
					tr.ncolumns);
		}
	}
			...
			if (s.conn.useJulian) {
				try {
					return new java.sql.Time(
							jsqlite.Database.long_from_julian(lastg));
	...
	public void updateAsciiStream(String colName, java.io.InputStream in, int s)
			throws SQLException {
		int col = findColumn(colName);
		updateAsciiStream(col, in, s);
	}

	public void updateBinaryStream(String colName, java.io.InputStream in, int s)
			throws SQLException {
		int col = findColumn(colName);
		updateBinaryStream(col, in, s);
	}

	public void updateCharacterStream(String colName, java.io.Reader in, int s)
			throws SQLException {
		int col = findColumn(colName);
	...
	public java.io.Reader getNCharacterStream(int colIndex) throws SQLException {
		throw new SQLFeatureNotSupportedException();
	}
	...
	public void updateNCharacterStream(int colIndex, java.io.Reader x, long len)
			throws SQLException {
		throw new SQLFeatureNotSupportedException();
	}
	...
	public void updateAsciiStream(int colIndex, java.io.InputStream x, long len)
			throws SQLException {
		throw new SQLFeatureNotSupportedException();
	}
	...
	public void updateBinaryStream(int colIndex, java.io.InputStream x, long len)
			throws SQLException {
		throw new SQLFeatureNotSupportedException();
	}
	...
	public void updateCharacterStream(int colIndex, java.io.Reader x, long len)
			throws SQLException {
		throw new SQLFeatureNotSupportedException();
	}

	public void updateCharacterStream(String colName, java.io.Reader x, long len)
			throws SQLException {
		int col = findColumn(colName);
		updateCharacterStream(col, x, len);
	}

	public void updateBlob(int colIndex, java.io.InputStream x, long len)
			throws SQLException {
		throw new SQLFeatureNotSupportedException();
	}

	public void updateBlob(String colName, java.io.InputStream x, long len)
			throws SQLException {
		int col = findColumn(colName);
		updateBlob(col, x, len);
	}

	public void updateClob(int colIndex, java.io.Reader x, long len)
			throws SQLException {
		throw new SQLFeatureNotSupportedException();
	}

	public void updateClob(String colName, java.io.Reader x, long len)
			throws SQLException {
		int col = findColumn(colName);
		updateClob(col, x, len);
	}

	public void updateNClob(int colIndex, java.io.Reader x, long len)
			throws SQLException {
		throw new SQLFeatureNotSupportedException();
	}

	public void updateNClob(String colName, java.io.Reader x, long len)
			throws SQLException {
		int col = findColumn(colName);
	...
	public void updateClob(int colIndex, java.io.Reader x) throws SQLException {
		throw new SQLFeatureNotSupportedException();
	}
	...
	public void updateNClob(int colIndex, java.io.Reader x) throws SQLException {
		throw new SQLFeatureNotSupportedException();
	}

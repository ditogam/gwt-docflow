...
public class JDBCDatabaseMetaData implements DatabaseMetaData {
	...
	public ResultSet getTables(String catalog, String schemaPattern,
		...
		sb.append("SELECT '' AS 'TABLE_CAT', " + "'' AS 'TABLE_SCHEM', "
				+ "tbl_name AS 'TABLE_NAME', "
				+ "upper(type) AS 'TABLE_TYPE', "
				+ "'' AS REMARKS FROM sqlite_master " + "WHERE tbl_name like ");
	...
	public ResultSet getColumns(String catalog, String schemaPattern,
		...
		String cols[] = { "TABLE_CAT", "TABLE_SCHEM", "TABLE_NAME",
		...
		int types[] = { Types.VARCHAR, Types.VARCHAR, Types.VARCHAR,
				Types.VARCHAR, Types.SMALLINT, Types.VARCHAR, Types.INTEGER,
	...
	public ResultSet getBestRowIdentifier(String catalog, String schema,
		...
		try {
			...
			rs1 = (JDBCResultSet) (s1.executeQuery("PRAGMA table_info("
					+ jsqlite.Shell.sql_quote(table) + ")"));
		} catch (SQLException e) {
			throw e;
		} finally {
		...
		String cols[] = { "SCOPE", "COLUMN_NAME", "DATA_TYPE", "TYPE_NAME",
				"COLUMN_SIZE", "BUFFER_LENGTH", "DECIMAL_DIGITS",
				"PSEUDO_COLUMN" };
		int types[] = { Types.SMALLINT, Types.VARCHAR, Types.SMALLINT,
		...
		tr.sql_types(types);
		JDBCResultSet rs = new JDBCResultSet((jsqlite.TableResult) tr, null);
		if (rs0 != null && rs0.tr != null && rs0.tr.nrows > 0 && rs1 != null
				&& rs1.tr != null && rs1.tr.nrows > 0) {
			...
			for (int i = 0; i < rs0.tr.nrows; i++) {
				...
				try {
					rs2 = (JDBCResultSet) (s2.executeQuery("PRAGMA index_info("
	...
	public ResultSet getPrimaryKeys(String catalog, String schema, String table)
		...
		if (rs0 != null && rs0.tr != null && rs0.tr.nrows > 0) {
			...
			for (int i = 0; i < rs0.tr.nrows; i++) {
				...
				JDBCResultSet rs1 = null;
				try {
					rs1 = (JDBCResultSet) (s1.executeQuery("PRAGMA index_info("
							+ jsqlite.Shell.sql_quote(iname) + ")"));
				} catch (SQLException e) {
				} finally {
					s1.close();
		...
		JDBCStatement s1 = new JDBCStatement(conn);
		try {
			rs0 = (JDBCResultSet) (s1.executeQuery("PRAGMA table_info("
					+ jsqlite.Shell.sql_quote(table) + ")"));
		} catch (SQLException e) {
			throw e;
		} finally {
	...
	public ResultSet getImportedKeys(String catalog, String schema, String table)
		...
		String cols[] = { "PKTABLE_CAT", "PKTABLE_SCHEM", "PKTABLE_NAME",
		...
		if (foreignTable != null && foreignTable.charAt(0) != '%') {
			...
			try {
				...
				rs0 = (JDBCResultSet) (s0
						.executeQuery("PRAGMA foreign_key_list("
	...
	public ResultSet getTypeInfo() throws SQLException {
		String cols[] = { "TYPE_NAME", "DATA_TYPE", "PRECISION",
		...
		int types[] = { Types.VARCHAR, Types.SMALLINT, Types.INTEGER,
				Types.VARCHAR, Types.VARCHAR, Types.VARCHAR, Types.SMALLINT,
				Types.BIT, Types.SMALLINT, Types.BIT, Types.BIT, Types.BIT,
		...
		tr.sql_types(types);
		JDBCResultSet rs = new JDBCResultSet(tr, null);
		String row1[] = { "VARCHAR", "" + Types.VARCHAR, "65536", "'", "'",
				null, "" + typeNullable, "1", "" + typeSearchable, "0", "0",
				"0", null, "0", "0", "0", "0", "0" };
		tr.newrow(row1);
		String row2[] = { "INTEGER", "" + Types.INTEGER, "32", null, null,
				null, "" + typeNullable, "0", "" + typeSearchable, "0", "0",
				"1", null, "0", "0", "0", "0", "2" };
		tr.newrow(row2);
		String row3[] = { "DOUBLE", "" + Types.DOUBLE, "16", null, null, null,
				"" + typeNullable, "0", "" + typeSearchable, "0", "0", "1",
				null, "0", "0", "0", "0", "10" };
		tr.newrow(row3);
		String row4[] = { "FLOAT", "" + Types.FLOAT, "7", null, null, null,
				"" + typeNullable, "0", "" + typeSearchable, "0", "0", "1",
				null, "0", "0", "0", "0", "10" };
		tr.newrow(row4);
		String row5[] = { "SMALLINT", "" + Types.SMALLINT, "16", null, null,
				null, "" + typeNullable, "0", "" + typeSearchable, "0", "0",
				"1", null, "0", "0", "0", "0", "2" };
		tr.newrow(row5);
		String row6[] = { "BIT", "" + Types.BIT, "1", null, null, null,
				"" + typeNullable, "0", "" + typeSearchable, "0", "0", "1",
				null, "0", "0", "0", "0", "2" };
		tr.newrow(row6);
		String row7[] = { "TIMESTAMP", "" + Types.TIMESTAMP, "30", null, null,
				null, "" + typeNullable, "0", "" + typeSearchable, "0", "0",
				"1", null, "0", "0", "0", "0", "0" };
		tr.newrow(row7);
		String row8[] = { "DATE", "" + Types.DATE, "10", null, null, null,
				"" + typeNullable, "0", "" + typeSearchable, "0", "0", "1",
				null, "0", "0", "0", "0", "0" };
		tr.newrow(row8);
		String row9[] = { "TIME", "" + Types.TIME, "8", null, null, null,
				"" + typeNullable, "0", "" + typeSearchable, "0", "0", "1",
				null, "0", "0", "0", "0", "0" };
		tr.newrow(row9);
		String row10[] = { "BINARY", "" + Types.BINARY, "65536", null, null,
				null, "" + typeNullable, "0", "" + typeSearchable, "0", "0",
				"1", null, "0", "0", "0", "0", "0" };
		tr.newrow(row10);
		String row11[] = { "VARBINARY", "" + Types.VARBINARY, "65536", null,
				null, null, "" + typeNullable, "0", "" + typeSearchable, "0",
				"0", "1", null, "0", "0", "0", "0", "0" };
		tr.newrow(row11);
		String row12[] = { "REAL", "" + Types.REAL, "16", null, null, null,
				"" + typeNullable, "0", "" + typeSearchable, "0", "0", "1",
				null, "0", "0", "0", "0", "10" };
		tr.newrow(row12);
		return rs;
	...
	public ResultSet getIndexInfo(String catalog, String schema, String table,
		...
		int types[] = { Types.VARCHAR, Types.VARCHAR, Types.VARCHAR, Types.BIT,
		...
		if (rs0 != null && rs0.tr != null && rs0.tr.nrows > 0) {
			...
			for (int i = 0; i < rs0.tr.nrows; i++) {
				...
				for (int k = 0; k < rs1.tr.nrows; k++) {
					...
					row[1] = "";
					row[2] = table;
					row[3] = (uniq.charAt(0) != '0' || (iname.charAt(0) == '(' && iname
							.indexOf(" autoindex ") > 0)) ? "0" : "1";
					row[4] = "";
					row[5] = iname;
	...
	public ResultSet getFunctionColumns(String cat, String schema, String func,

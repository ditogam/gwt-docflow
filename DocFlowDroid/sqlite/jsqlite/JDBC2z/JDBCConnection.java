...
public class JDBCConnection implements java.sql.Connection, jsqlite.BusyHandler {
	...
	private DatabaseX open(boolean readonly) throws SQLException {
		...
		try {
			...
			dbx.open(
					dbfile,
					readonly ? jsqlite.Constants.SQLITE_OPEN_READONLY
	...
	public JDBCConnection(String url, String enc, String pwd, String drep,
			String vfs) throws SQLException {

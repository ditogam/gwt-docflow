...
public class IDValueArrayAdapter extends ArrayAdapter<ClSelectionItem> {

	ArrayList<ClSelectionItem> values = new ArrayList<ClSelectionItem>();
	private Context appContext;
	private FieldDefinition field;

	public IDValueArrayAdapter(ArrayList<ClSelectionItem> values,
			Context appContext) {
		super(appContext, android.R.layout.simple_dropdown_item_1line);
		this.values = values;
	...
	public IDValueArrayAdapter(HashMap<Long, String> map, Context appContext) {
		super(appContext, android.R.layout.simple_dropdown_item_1line);
		this.appContext = appContext;
		setValues(map);
	}

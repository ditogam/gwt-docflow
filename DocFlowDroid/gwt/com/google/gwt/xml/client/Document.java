...
public interface Document extends Node {
	 ...
	 * 
	 * @param data
	 *            the data of the new <code>CDATASection</code>
	 ...
	 * 
	 * @param data
	 *            the data of the new <code>Comment</code>
	 ...
	 * 
	 * @param tagName
	 *            the tag name of the new <code>Element</code>
	 ...
	 * 
	 * @param target
	 *            the target of the new <code>ProcessingInstruction</code>
	 * @param data
	 *            the data of the new <code>ProcessingInstruction</code>
	 ...
	 * 
	 * @param data
	 *            the data of the new <code>Text</code>
	 ...
	 * <code>elementId</code>. Note the attribute which is used as an ID must be
	 * supplied in the DTD of the document. It is not sufficient to give the

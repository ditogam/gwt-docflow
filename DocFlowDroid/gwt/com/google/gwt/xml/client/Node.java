...
public interface Node {
	 ...
	 *            the <code>Node</code> to be added
	 * @param refChild
	 *            the <code>Node</code> which determines the position to insert
	 ...
	 * depending on the implementation. Safari 4.0 and Chrome will also merge
	 * CDATA nodes into text nodes, even though they support CDATA nodes as
	 * distinct nodes.
	 */
	void normalize();

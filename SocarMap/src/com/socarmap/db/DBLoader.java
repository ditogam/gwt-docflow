...
public class DBLoader {
	...
	public static DBLoader initInstance(String dbPath) throws Throwable {
		if (instance == null)
	...
	private DBLoader(String _dbPath) throws Throwable {

		this.dbPath = _dbPath;
		reloadClassifiers();
	}

	public void reloadClassifiers() throws jsqlite.Exception, Exception {

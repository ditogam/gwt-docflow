...
abstract class Geometry implements Serializable {
	 ...
	 * Geometries must have a valid dimension (2 or 3) and a valid type.
	 * 2-dimensional Points must have Z=0.0, as well as non-measured Points must
	 * have m=0.0. Composed geometries must have all equal SRID, dimensionality
	 * and measures, as well as that they do not contain NULL or inconsistent
	 * subgeometries. BinaryParser and WKTParser should only generate consistent
	 * geometries. BinaryWriter may produce invalid results on inconsistent
	 * geometries.
	 * 

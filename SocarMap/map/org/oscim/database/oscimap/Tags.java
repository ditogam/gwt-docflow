...
public class Tags {
	...
	public final static String[] keys = { "access".intern(),
			"addr:housename".intern(), "addr:housenumber".intern(),
			"addr:interpolation".intern(), "admin_level".intern(),
			"aerialway".intern(), "aeroway".intern(), "amenity".intern(),
			"area".intern(), "barrier".intern(), "bicycle".intern(),
			"brand".intern(), "bridge".intern(), "boundary".intern(),
			"building".intern(), "construction".intern(), "covered".intern(),
			"culvert".intern(), "cutting".intern(), "denomination".intern(),
			"disused".intern(), "embankment".intern(), "foot".intern(),
			"generator:source".intern(), "harbour".intern(),
			"highway".intern(), "historic".intern(), "horse".intern(),
			"intermittent".intern(), "junction".intern(), "landuse".intern(),
			"layer".intern(), "leisure".intern(), "lock".intern(),
			"man_made".intern(), "military".intern(), "motorcar".intern(),
			"name".intern(), "natural".intern(), "oneway".intern(),
			"operator".intern(), "population".intern(), "power".intern(),
			"power_source".intern(), "place".intern(), "railway".intern(),
			"ref".intern(), "religion".intern(), "route".intern(),
			"service".intern(), "shop".intern(), "sport".intern(),
			"surface".intern(), "toll".intern(), "tourism".intern(),
			"tower:type".intern(), "tracktype".intern(), "tunnel".intern(),
			"water".intern(), "waterway".intern(), "wetland".intern(),
			"width".intern(), "wood".intern() };

	// most common tags, ordered by tag count
	public final static Tag[] tags = { new Tag(s_building, s_yes, false),
			...
			new Tag(s_place, s_island, false), new Tag(s_oneway, s__1, false),
			...
			new Tag(s_bench, s_yes, false), new Tag(s_oneway, s_1, false),
			...
			new Tag(s_route, s_bus, false), new Tag(s_shop, s_bakery, false),
			...
			new Tag(s_natural, s_bay, false), new Tag(s_shop, s_kiosk, false),
			...
			new Tag(s_shop, s_bicycle, false), new Tag(s_route, s_foot, false),
			...
			new Tag(s_shop, s_chemist, false), new Tag(s_shop, s_shoes, false),
			...
			new Tag(s_bridge, s_no, false), new Tag(s_wetland, s_bog, false),
			...
			new Tag(s_shop, s_optician, false), new Tag(s_shop, s_yes, false),
			...
			new Tag(s_natural, s_rock, false), new Tag(s_tunnel, s_no, false),
			...
			new Tag(s_shop, s_gift, false), new Tag(s_place, s_farm, false),
			...
			new Tag(s_amenity, s_bbq, false), new Tag(s_shop, s_sports, false),
			...
			new Tag(s_surface, s_earth, false), new Tag(s_shop, s_hifi, false),
			...
			new Tag(s_route, s_train, false), new Tag(s_building, s_no, false),
			...
			new Tag(s_waterway, s_lock, false), new Tag(s_area, s_yes, false),

...
public class MapInfo {
	 ...
	 *            TODO
	 */
	public MapInfo(BoundingBox bbox, Byte zoom, GeoPoint start,
			String projection, long date, long size, int version,
			String language, String comment, String createdBy, int[] zoomLevel) {

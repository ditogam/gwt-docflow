...
/**
 * Callback methods which can be triggered from the {@link MapDatabase}. ____
 * NOTE: All parameters passed belong to the caller! i.e. dont hold references
 * to any arrays after callback function returns.
 */
public interface IMapDatabaseCallback {
	 ...
	 */
	void renderPointOfInterest(byte layer, Tag[] tags, float latitude,
			float longitude);

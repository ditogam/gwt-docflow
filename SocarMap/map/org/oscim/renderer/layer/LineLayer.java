...
public final class LineLayer extends Layer {
	 ...
	 * @param index
	 *            array of indices holding the length of the individual line
	 *            coordinates (i.e. points * 2). when index is null one a line
	 *            with points.length is assumed.
	 * @param closed
	...
	public void addLine(float[] points, short[] index, boolean closed) {
		...
		// Note: just a hack to save some vertices, when there are more than 200
		// lines
		// per type
		if (rounded) {
			int cnt = 0;

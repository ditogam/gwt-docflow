...
public class TriangleJNI {
	...
	//
	// public static synchronized int triangulate(float[] points, int pos, int
	// len, short[] indices) {
	//
	// int numRings = 1;
	//
	...
	// // Log.d("triangle", ">>" + sBuf.get()+ " "+ sBuf.get() + " "+
	// sBuf.get());
	// // }
	//
	 ...
	 * @param numRings
	 *            number of rings in polygon == outer(1) + inner rings
	 * @param io
	 *            input: 1. number of all points, 2.. number of points in rings
	 *            - times 2! output: indices of triangles, 3 per triangle :)
	 *            (indices use stride=2, i.e. 0,2,4...)
	 * @param ioffset
	 *            offset used to add offset to indices
	 * @return number of triangles in io buffer
	 */
	public static native int triangulate(FloatBuffer points, int numRings,

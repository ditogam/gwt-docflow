...
public class MapScaleBar {
	...
	private static final Paint SCALE_BAR_STROKE = new Paint(
			Paint.ANTI_ALIAS_FLAG);
	private static final int[] SCALE_BAR_VALUES_IMPERIAL = { 26400000,
			10560000, 5280000, 2640000, 1056000, 528000, 264000, 105600, 52800,
			26400, 10560, 5280, 2000, 1000, 500, 200, 100, 50, 20, 10, 5, 2, 1 };
	private static final int[] SCALE_BAR_VALUES_METRIC = { 10000000, 5000000,
	...
	private static final Paint SCALE_TEXT_STROKE = new Paint(
			Paint.ANTI_ALIAS_FLAG);
	...
	private void drawScaleBar(float scaleBarLength, Paint paint) {
		...
		mMapScaleCanvas.drawLine(scaleBarLength + 5, 10, scaleBarLength + 5,
				40, paint);
	}
	...
	private boolean isRedrawNecessary() {
		...
		MapPosition currentMapPosition = mMapView.getMapPosition()
				.getMapPosition();
	...
	void redrawScaleBar() {
		...
		double groundResolution = MercatorProjection.calculateGroundResolution(
				mMapPosition.lat, mMapPosition.zoomLevel);

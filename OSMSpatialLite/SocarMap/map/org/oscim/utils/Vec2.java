...
public final class Vec2 {
	...
	public final static void add(float[] result, int rpos, float[] a, int apos,
			float[] b, int bpos) {
	...
	public static float dot(float[] a, int apos, float[] b, int bpos) {
		return a[apos << 1] * b[bpos << 1] + a[(apos << 1) + 1]
				* b[(bpos << 1) + 1];
	}
	...
	public final static void sub(float[] result, int rpos, float[] a, int apos,
			float[] b, int bpos) {
		result[(rpos << 1) + 0] = a[(apos << 1) + 0] - b[(bpos << 1) + 0];
		result[(rpos << 1) + 1] = a[(apos << 1) + 1] - b[(bpos << 1) + 1];
	}

...
public class LineClipper {
	...
	private static boolean clip(int x0, int y0, int x1, int y1, int xmin,
			int ymin, int xmax, int ymax, int outcode0, int outcode1, int[] out) {
	...
	public int clipNext(int x1, int y1) {
		...
		if ((mPrevOutcode | outcode) == 0) {
			...
			accept = clip(mPrevX, mPrevY, x1, y1, xmin, ymin, xmax, ymax,
					mPrevOutcode, outcode, this.out) ? -1 : 0;
		}

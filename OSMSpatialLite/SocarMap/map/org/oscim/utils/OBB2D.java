...
public class OBB2D {
	...
	public OBB2D(float cx, float cy, float width, float height, double acos,
			double asin) {
	...
	public OBB2D(float cx, float cy, float dx, float dy, float width,
			float height) {
	...
	public void set(float cx, float cy, float dx, float dy, float width,
			float height) {
		float vx = cx - dx;
		float vy = cy - dy;
	...
	public void setNormalized(float cx, float cy, float vx, float vy,

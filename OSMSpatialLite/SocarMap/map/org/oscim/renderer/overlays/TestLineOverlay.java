...
public class TestLineOverlay extends RenderOverlay {
	...
	public synchronized void render(MapPosition pos, Matrices m) {
		...
		GLES20.glVertexAttribPointer(htestVertexFlip, 1, GLES20.GL_BYTE, false,
				0, 0);
		...
		// first pass
		GLES20.glVertexAttribPointer(htestVertexPosition0, 4, GLES20.GL_SHORT,
				false, STRIDE, STRIDE);
		GlUtils.checkGlError("2");

		GLES20.glVertexAttribPointer(htestVertexLength0, 2, GLES20.GL_SHORT,
				false, STRIDE, STRIDE + LEN_OFFSET);
		GlUtils.checkGlError("3");

		GLES20.glVertexAttribPointer(htestVertexPosition1, 4, GLES20.GL_SHORT,
				false, STRIDE, 0);
		GlUtils.checkGlError("4");

		GLES20.glVertexAttribPointer(htestVertexLength1, 2, GLES20.GL_SHORT,
				false, STRIDE, LEN_OFFSET);
		...
		// second pass
		GLES20.glVertexAttribPointer(htestVertexPosition0, 4, GLES20.GL_SHORT,
				false, STRIDE, 2 * STRIDE);

		GLES20.glVertexAttribPointer(htestVertexLength0, 2, GLES20.GL_SHORT,
				false, STRIDE, 2 * STRIDE + LEN_OFFSET);
	...
	public synchronized void update(MapPosition curPos,
		...
		htestVertexPosition0 = GLES20
				.glGetAttribLocation(testProgram, "a_pos0");
		htestVertexPosition1 = GLES20
				.glGetAttribLocation(testProgram, "a_pos1");
		...
		float points[] = { -800, -800, 800, -800, 800, 800, -800, 800, -800,
				-800, };
		...
		ByteBuffer buf = ByteBuffer.allocateDirect(numVertices * 6 * 2).order(

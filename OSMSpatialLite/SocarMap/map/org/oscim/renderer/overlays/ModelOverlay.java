...
public class ModelOverlay extends RenderOverlay {
	...
	private final float[] box = {
			// north
			-200f, -200f, 0, 0.9f, 200f, -200f, 0, 0.9f, -200f, -200f, 0.15f,
			0.9f, 200f, -200f,
			0.15f,
			0.9f,

			// west
			-200f, -200f, 0, 0.8f, -200f, 200f, 0, 0.8f, -200f, -200f, 0.15f,
			0.8f, -200f, 200f, 0.15f,
			0.8f,

			// south
			200f, 200f, 0, 0.7f, -200f, 200f, 0, 0.7f, 200f, 200f, 0.15f, 0.7f,
			-200f, 200f, 0.15f, 0.7f,

			// east
			200f, -200f, 0, 1.0f, 200f, 200f, 0, 1.0f, 200f, -200f, 0.15f,
			1.0f, 200f, 200f, 0.15f, 1.0f, };
	...
	final static String polygonVertexShader = "" + "precision mediump float;"
			+ "uniform mat4 u_mvp;" + "uniform vec4 u_color;"
			+ "attribute vec4 a_position;" + "attribute float a_light;"
			+ "varying vec4 color;" + "void main() {"
			+ "  gl_Position = u_mvp * a_position;" + "  if (u_color.a == 0.0)"
			+ "  color = vec4(u_color.rgb * a_light, 0.8);" + "  else"
			+ "  color = u_color;" + "}";

	final static String polygonFragmentShader = "" + "precision mediump float;"
			+ "varying vec4 color;" + "void main() {"
			+ "  gl_FragColor = color;" + "}";
	...
	public synchronized void render(MapPosition pos, Matrices m) {
		...
		GLState.enableVertexArrays(hPolygonVertexPosition,
				hPolygonLightPosition);

		GLES20.glBindBuffer(GLES20.GL_ELEMENT_ARRAY_BUFFER, mIndicesBufferID);
		GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, mVertexBufferID);

		GLES20.glVertexAttribPointer(hPolygonVertexPosition, 3,
				GLES20.GL_FLOAT, false, 16, 0);
		GLES20.glVertexAttribPointer(hPolygonLightPosition, 1, GLES20.GL_FLOAT,
				false, 16, 12);
		...
		GLES20.glDrawElements(GLES20.GL_TRIANGLES, 30,
	...
	public synchronized void update(MapPosition curPos,
		...
		hPolygonVertexPosition = GLES20.glGetAttribLocation(polygonProgram,
				"a_position");
		hPolygonLightPosition = GLES20.glGetAttribLocation(polygonProgram,
				"a_light");
		...
		ByteBuffer buf = ByteBuffer.allocateDirect(64 * 4).order(
		...
		sbuf.flip();
		GLES20.glBindBuffer(GLES20.GL_ELEMENT_ARRAY_BUFFER, mIndicesBufferID);
		GLES20.glBufferData(GLES20.GL_ELEMENT_ARRAY_BUFFER, 30 * 2, sbuf,
		...
		fbuf.flip();
		GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, mVertexBufferID);
		GLES20.glBufferData(GLES20.GL_ARRAY_BUFFER, 64 * 4, fbuf,
				GLES20.GL_STATIC_DRAW);

...
public abstract class RenderOverlay {
	...
	/**
	 * called 2. compile everything for drawing Set 'isReady' true when things
	 ...
	 * MapPosition and the last updated Overlay MapPosition and add m.viewproj
	 * 
	 * @param curPos
	 *            ...
	 * @param m
	...
	protected void setMatrix(MapPosition curPos, Matrices m, boolean project) {
		...
		GlUtils.setMatrix(m.mvp, x * scale, y * scale, s
				/ GLRenderer.COORD_SCALE);

...
public abstract class ItemizedOverlay<Item extends OverlayItem> extends Overlay
	 ...
	 */
	public static synchronized Drawable boundToHotspot(final Drawable marker,
	...
	// * first.<br/>
	// * <br/>
	// * The marker will be drawn twice for each Item in the Overlay--once in
	// the
	...
	protected final void populate() {
		synchronized (lock) {
			...
			for (int a = 0; a < size; a++) {
				...
				it.px = (int) MercatorProjection.longitudeToPixelX(
						p.getLongitude(), MAX_ZOOM);
				it.py = (int) MercatorProjection.latitudeToPixelY(
	...
	// */
	// protected void onDrawItem(final Canvas canvas, final Item item, final

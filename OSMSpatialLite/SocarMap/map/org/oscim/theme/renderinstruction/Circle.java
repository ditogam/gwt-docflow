...
public final class Circle extends RenderInstruction {
	 ...
	 */
	public static Circle create(String elementName, Attributes attributes,
			int level) {
		Float radius = null;
	...
	private static void validate(String elementName, Float radius,
			float strokeWidth) {
		if (radius == null) {
			throw new IllegalArgumentException(
					"missing attribute r for element: " + elementName);
	...
	public void renderNode(IRenderCallback renderCallback, Tag[] tags) {
		if (mOutline != null) {
			renderCallback.renderPointOfInterestCircle(mRenderRadius, mOutline,
					mLevel);
		}
		if (mFill != null) {
			renderCallback.renderPointOfInterestCircle(mRenderRadius, mFill,
					mLevel);
		}
	}

...
public final class Area extends RenderInstruction {
	 ...
	 */
	public static Area create(String elementName, Attributes attributes,
			int level) {
		String src = null;
		...
		return new Area(style, src, fill, stroke, strokeWidth, fade, level,
				blend, blendFill);
	}
	 ...
	 *            ...
	 */
	private Area(String style, String src, int fill, int stroke,
			float strokeWidth, int fade, int level, int blend, int blendFill) {
		super();
		this.style = style;

...
final class QueryCalculations {
	static void calculateBaseTiles(QueryParameters queryParameters, Tile tile,
		...
		if (tile.zoomLevel < subFileParameter.baseZoomLevel) {
			...
			int zoomLevelDifference = tile.zoomLevel
			...
			queryParameters.queryTileBitmask = calculateTileBitmask(tile,
					zoomLevelDifference);
		} else {
	...
	private static int getSecondLevelTileBitmaskLowerLeft(long subtileX,
			long subtileY) {
	...
	private static int getSecondLevelTileBitmaskLowerRight(long subtileX,
			long subtileY) {
		if (subtileX % 2 == 0 && subtileY % 2 == 0) {
			// upper left sub-tile
			return 0x20;
	...
	private static int getSecondLevelTileBitmaskUpperLeft(long subtileX,
			long subtileY) {
		if (subtileX % 2 == 0 && subtileY % 2 == 0) {
			// upper left sub-tile
			return 0x8000;
	...
	private static int getSecondLevelTileBitmaskUpperRight(long subtileX,
			long subtileY) {
		if (subtileX % 2 == 0 && subtileY % 2 == 0) {
			// upper left sub-tile
			return 0x2000;

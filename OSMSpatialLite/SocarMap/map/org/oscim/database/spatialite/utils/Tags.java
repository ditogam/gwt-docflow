...
public final class Tags {
	...
	/**
	 * Resolutions (meters/pixel) for each zoom level in the Mercator
	 * Projection. These values are precalculated using
	 * TileConversor.resolutionMercator(int zoomLevel) method.
	 */
	...
	/**
	 * Yahoo minZoomLevel == 17 (GoogleMinZoomLevel == 0) first YAHOO_y =
	 * (2*map.zoomLevel) +1 Yahoo_zoom = 17 => 0 Yahoo_zoom = 16 => 1 Yahoo_zoom
	 * = 15 => 3 Yahoo_zoom = 14 => 7 Yahoo_zoom = 13 => 15 : para zoomLevel > 0
	 * : YAHOO_Y = 2*(map.zoomLevel-1) +1 sino : YAHOO_Y = 0
	 */

...
public class MapDatabase implements IMapDatabase {
	...
	private final short[] mIndex = new short[4];
	// private Tag[] mTags = { new Tag("boundary", "administrative"), new
	// Tag("admin_level", "2") };
	private final Tag[] mTags = { new Tag("natural", "water") };
	private final Tag[] mTagsWay = { new Tag("highway", "primary"),
			new Tag("name", "Highway Rd") };

	// private Tag[] mNameTags;

	private final MapInfo mMapInfo = new MapInfo(new BoundingBox(-180, -90,
			180, 90), new Byte((byte) 0), null, PROJECTION, 0, 0, 0, "de",
			"yo!", "by me", null);
	...
	public QueryResult executeQuery(JobTile tile,
		...
		mapDatabaseCallback
				.renderWay((byte) 0, mTags, mCoords, mIndex, true, 0);
		...
		tags[1] = mTagsWay[1];
		mapDatabaseCallback
				.renderWay((byte) 0, tags, mCoords, mIndex, false, 0);
		...
		tags[1] = mTagsWay[1];
		mapDatabaseCallback
				.renderWay((byte) 1, tags, mCoords, mIndex, false, 0);
